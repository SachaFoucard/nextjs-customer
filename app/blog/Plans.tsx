...
export default function Plans() {
    ...
    return (
        <SectionPrice className='rounded-4xl mr-auto my-40 border-black w-full shadow-lg h-auto bg-#305348-800'>
            ...
            <div className='flex-cols-1 md:flex md:pt-10 lg:pt-20'>
                {/* Rendering plan cards using map function */}
                {plans.map((plan, index) => (
                    <div key={index} className='left bg-white text-[#305348] space-y-1 border p-10 leading-10 rounded-lg shadow-2xl my-5 py-7 w-80 m-auto'>
